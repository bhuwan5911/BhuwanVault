...
document.body.prepend(message); //append se end mai node add hota hai, prepebd se shuruvaat mai node add hojata hai
...
box.addEventListener("click", () => {
  ...
  if (!game.start) {
    ...
    message.textContent = `It took ${duration} second to click`;
  }
});
